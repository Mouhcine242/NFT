...
export default function CreateItem() {
    ...
    async function createSale(url) {
      ...
      /* create the NFT */
      let contract1 = new ethers.Contract(nftaddresses, NFT.abi, signer)
      ...
      transaction = await contract.createMarketItem(tokenId, nftaddresses , price, { value: listingPrice })
